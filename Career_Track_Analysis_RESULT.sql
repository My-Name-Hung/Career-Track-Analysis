...
-- Extracting and result data need tracking
CREATE TABLE career_track_competition AS 
(
	SELECT
	   student_id,
	   track_name,
	...
	(
		SELECT
			...
			EXTRACT(DAY FROM AGE(b.date_completed, b.date_enrolled)) AS days_for_competition
		FROM
			career_track_info a
		JOIN 
